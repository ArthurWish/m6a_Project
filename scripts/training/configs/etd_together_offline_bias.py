"""Current ETD together offline-bias training config.

This is the canonical config for the maintained ETD-together + offline
secondary-structure bias path.
"""
...
CONFIG = {
    "exp_name": "v4_multitask_m6a_rbp_offline_bias_hw256_bs64_e10_rand33_ddp3",
    "seed": 42,
    # Data
    ...
    "offline_cache_max_transcripts": 64,
